...
<body>
  <div class="rv-breadcrumb pt-120 pb-120">
    <div class="container">
      <h1 class="rv-breadcrumb__title"> Investor Queries & Complaint</h1>
      ...
      <ul class="rv-breadcrumb__nav d-flex justify-content-center">
        ...
        <li class="current-page"><span class="dvdr"> &#47;</span><span>Investor Queries & Complaint</span></li>
      </ul>
    </div>
  </div>
...
<div class="container mt-5">
    <div class="col-12">
    <h1> <i class="fa-solid fa-square-check"></i> INVESTOR QUERIES & COMPLAIENT</h1>
    </div>
</div>
