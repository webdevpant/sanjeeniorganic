...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyCbvJXeT3kAaKNb1j_FkDdhPjFIE3V4jO0'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	...
	var $center						= "22.1005619,73.7742609";		// Sets the default center location (lat/long co-ordinate or address) of the map. If defaulting to the users location set to "auto"
	...
	var $placesLocation				= '28.5275198,77.0688969';						// A point (lat/long co-ordinate or address) on the map if the search for places is based around a central point
	var $placesRadius				= 10;						// The radius (in meters) if search is based around a central position
	...
	var $placesName					= 'Delhi,Gurgaon,Noida';						// A term to be matched against when searching for places to display on the map
