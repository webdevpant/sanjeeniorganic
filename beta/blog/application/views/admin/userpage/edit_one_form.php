               ...
               <div class="col-md-4">
                ...
                <div class="form-group">
                     ...
                     <select name="debt_type_3" class="form-control">
                        <option value="">Select Debt Type</option>
                        <option value="Credit Card" <?php if($form_data->debt_type_3 == "Credit Card") echo "selected"; ?>>Credit Card</option>
                        <option value="Medical Bills" <?php if($form_data->debt_type_3 == "Medical Bills") echo "selected"; ?>>Medical Bills</option>
                        <option value="Personal Loans" <?php if($form_data->debt_type_3 == "Personal Loans") echo "selected"; ?>>Personal Loans</option>
                        <option value="Payday Loans" <?php if($form_data->debt_type_3 == "Payday Loans") echo "selected"; ?>>Payday Loans</option>
                        <option value="Student Loan" <?php if($form_data->debt_type_3 == "Student Loan") echo "selected"; ?>>Student Loan</option>
                        <option value="Tax Debt" <?php if($form_data->debt_type_3 == "Tax Debt") echo "selected"; ?>>Tax Debt</option>
                     </select>
                 </div>
               </div>
               <div class="col-md-4">
