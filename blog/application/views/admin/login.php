...
<head>
  ...
  <title>sanjeevaniagrofoods | Blog | Log in</title>
...
<div class="login-box" style="margin: 8% auto;">
  ...
  <div class="login-box-body">
    ...
    <?php } ?>
    <p class="login-box-msg" style="padding: 7px 20px 7px 20px; background-color: #00a65a; margin-bottom: 9px; color: #fff;">sanjeevaniagrofoods</p>
   <!--  <p class="login-box-msg" style="padding: 7px 20px 7px 20px; margin-bottom: 9px; color:#ff0000;"><?php echo @$error_message; ?></p> -->
    ...
    <!--<a href="<?php //echo base_url('Admin/forgetPassword'); ?>">I forgot my password</a>
