...
<div class="general-single-page-layout single-page-layout-one">
  <div class="breadcrumb-wrapper">
      ...
      <ul class="breadcrumb-listing">
        <li><a href="https://www.sanjeevaniagrofoods.com/beta/blog/">About Agriculture</a></li>
        <li><a href="#">Organic Farmacy</a></li>
      </ul>
      <div class="mask"></div>
    <!-- // breadcrumb -->
  </div>
...
<div class="post-search-panel" style="display: none;">
  <input type="text" id="keywords"class="custom-button " placeholder="Type keywords to filter posts" onkeyup="searchFilter();"/>
...
function searchFilter(page_num){
    ...
    $.ajax({
        type: 'POST',
        url: '<?php echo base_url('Website/ajaxPaginationData/'); ?>'+page_num,
